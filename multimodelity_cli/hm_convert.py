...
from multimodelity.utils.download import copy, decompress, move
...
class HMConverter:
    ...
    def get_parser(self):
        ...
        parser.add_argument(
            "--move", required=None, type=int, help="Move data dir to multimodelity cache dir"
        )
        parser.add_argument(
            "--multimodelity_data_folder", required=None, type=str, help="multimodelity Data folder"
        )
        parser.add_argument(
            "--bypass_checksum",
            required=None,
    ...
    def convert(self):
        ...
        if self.args.multimodelity_data_folder:
            data_dir = self.args.multimodelity_data_folder
