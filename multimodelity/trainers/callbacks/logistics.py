...
import torch
from multimodelity.trainers.callbacks.base import Callback
from multimodelity.utils.configuration import get_multimodelity_env
from multimodelity.utils.distributed import is_master
from multimodelity.utils.logger import TensorboardLogger, log_progress, setup_output_folder
...
class LogisticsCallback(Callback):
    ...
    def __init__(self, config, trainer):
        ...
        if self.training_config.tensorboard:
            ...
            env_tb_logdir = get_multimodelity_env(key="tensorboard_logdir")
            if env_tb_logdir:
