...
# adapted for multimodelity use cases.
...
from multimodelity.utils.general import get_absolute_path
...
class DownloadableFile:
    ...
    Originally taken from ParlAI, this file has been modified for multimodelity specific
    use cases.
    ...
    multimodelity_PREFIX = "multimodelity://"
    multimodelity_PREFIX_REPLACEMENT = "https://dl.fbaipublicfiles.com/multimodelity/data/"
    ...
    def _parse_url(self, url):
        if url.find(self.multimodelity_PREFIX) == -1:
            return url
        else:
            return self.multimodelity_PREFIX_REPLACEMENT + url[len(self.multimodelity_PREFIX) :]
