...
from multimodelity.utils.distributed import get_rank, is_master
...
def setup_very_basic_config(color=True):
    ...
    # log a message even before logging is setup by multimodelity.
...
# ColorfulFormatter is adopted from Detectron2 and adapted for multimodelity
