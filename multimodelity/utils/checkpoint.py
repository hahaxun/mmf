...
from multimodelity.utils.general import get_current_device, updir
...
def _hack_imports():
    ...
    sys.modules["pythia"] = importlib.import_module("multimodelity")
    sys.modules["pythia.utils.configuration"] = importlib.import_module(
        "multimodelity.utils.configuration"
    )
