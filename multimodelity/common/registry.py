...
"""
Registry is central source of truth in multimodelity. Inspired from Redux's
...
class Registry:
    ...
    def register_trainer(cls, name):
        ...
        Usage::
            ...
            from multimodelity.common.registry import registry
            from multimodelity.trainers.custom_trainer import CustomTrainer
    ...
    def register_metric(cls, name):
        ...
        Usage::
            ...
            from multimodelity.common.registry import registry
            from multimodelity.modules.metrics import BaseMetric
    ...
    def register_processor(cls, name):
        ...
        def wrap(func):
            from multimodelity.datasets.processors.processors import BaseProcessor
    ...
    def register_decoder(cls, name):
        ...
        Usage::
            ...
            from multimodelity.common.registry import registry
            from multimodelity.utils.text import TextDecoder
    ...
    def get(cls, name, default=None, no_warning=False):
        ...
        Args:
            ...
            no_warning (bool): If passed as True, warning when key doesn't exist
                               will not be generated. Useful for multimodelity's
