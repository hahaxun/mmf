...
dataset. To work with multimodelity, minimum requirement for datasets is to return
...
class Sample(OrderedDict):
    """Sample represent some arbitrary data. All datasets in multimodelity must
...
def to_device(
    ...
    if not isinstance(sample_list, SampleList):
        warnings.warn(
            ...
            "multimodelity expects you to move your tensors to cuda yourself."
        )
        return sample_list
