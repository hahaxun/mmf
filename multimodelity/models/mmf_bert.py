...
from multimodelity.models.pythia import Pythia
from multimodelity.modules.embeddings import ProjectionEmbedding
from multimodelity.utils.transform import transform_to_batch_sequence
...
@registry.register_model("multimodelity_bert")
class multimodelityBert(Pythia):
    def __init__(self, config):
        super().__init__(config)

    @classmethod
    def config_path(cls):
        return "configs/models/multimodelity_bert/defaults.yaml"
