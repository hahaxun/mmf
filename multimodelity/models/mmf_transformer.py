...
from multimodelity.models.transformers.base import (
    BaseTransformer,
    BaseTransformerConfigType,
    BaseTransformerInput,
)
from multimodelity.utils.build import build_encoder
from omegaconf import OmegaConf
from torch import Tensor, nn
from transformers.modeling_bert import BertPooler, BertPredictionHeadTransform


@registry.register_model("multimodelity_transformer")
class multimodelityTransformer(BaseTransformer):
    ...
    def config_path(cls) -> str:
        return "configs/models/multimodelity_transformer/defaults.yaml"
    ...
    def postprocess_output(self, output: Tensor) -> Dict[str, Tensor]:
        ...
        This will be used to calculate losses and metrics in multimodelity.
        """
        output_dict = {}
