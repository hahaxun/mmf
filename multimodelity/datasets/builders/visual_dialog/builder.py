...
from multimodelity.common.constants import VISUAL_DIALOG_CONSTS
from multimodelity.common.registry import registry
from multimodelity.datasets.builders.visual_dialog.dataset import VisualDialogDataset
from multimodelity.datasets.builders.visual_genome.builder import VisualGenomeBuilder
from multimodelity.utils.download import decompress, download
...
class VisualDialogBuilder(VisualGenomeBuilder):
    ...
    def build(self, config, dataset_type):
        ...
        self._config = config
        data_folder = os.path.join(get_multimodelity_root(), self._config.data_dir)
