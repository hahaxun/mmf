...
from multimodelity.utils.visualize import visualize_images
from PIL import Image
from torchvision import transforms


class HatefulMemesFeaturesDataset(multimodelityDataset):
...
class HatefulMemesImageDataset(multimodelityDataset):
    def __init__(self, config, *args, dataset_name="hateful_memes", **kwargs):
        super().__init__(dataset_name, config, *args, **kwargs)
        assert (
            self._use_images
