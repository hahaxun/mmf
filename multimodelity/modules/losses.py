...
multimodelity using the following example.
...
class multimodelityLoss(nn.Module):
    """Internal multimodelity helper and wrapper class for all Loss classes.
    ...
    .. note::
        ...
        Since, ``multimodelityLoss`` is used by the ``Losses`` class, end user
...
class MultiLoss(nn.Module):
    ...
    def __init__(self, params):
        ...
        for loss_params in params["params"]:
            ...
            loss_fn = multimodelityLoss(loss_params)
