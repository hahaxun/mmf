...
import torch
from multimodelity.common.registry import registry
from multimodelity.datasets.processors.processors import EvalAIAnswerProcessor
...
class Metrics:
    """Internally used by multimodelity, Metrics acts as wrapper for handling
...
class BaseMetric:
    """Base class to be inherited by all metrics registered to multimodelity. See
...
class TextVQAAccuracy(BaseMetric):
    def __init__(self):
        ...
        import multimodelity.utils.m4c_evaluators as evaluators
